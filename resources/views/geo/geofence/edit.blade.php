...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-geofence', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::model($geofence, array('route' => array('geofence.update', $geofence->id), 
        'method' => 'PUT', 'id' => 'form-edit-geofence', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
                ...
                <div class="form-group">
                    {!! Form::label('geofence_type_id', Lang::choice('messages.geofence-type', 1), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::select('geofence_type', array(''=>trans('messages.select-geofence-type'))+$geofenceTypes,
                            old('geofenceType') ? old('geofenceType') : $geofenceType, 
                            array('class' => 'form-control', 'id' => 'geofence_type')) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('geofence_owner_id', Lang::choice('messages.geofence-owner', 1), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::select('geofence_owner', array(''=>trans('messages.select-geofence-owner'))+$geofenceOwners,
                            old('geofenceOwner') ? old('geofenceOwner') : $geofenceOwner, 
                            array('class' => 'form-control', 'id' => 'geofence_owner')) !!}
                    </div>
                </div>
                <div class="form-group">
